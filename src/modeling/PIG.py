...
class CLIPVisionViPEmbeddings(nn.Module):
    ...
    def forward(self, pixel_values: torch.FloatTensor) -> torch.Tensor:
        ...
        # 这里的L已经算过cls within frame的数量了，所以下面的M 只+1
        # N = T*(1+H*W)
...
class CLIPAttention(nn.Module):
    ...
    def forward2(self, hidden_states, inputs_size):
        ...
        # in-frame attention:
        # q: within frame patches; k/v: within frame patches + global tokens
...
# PIG 三层抽象
# CLIP vip中只有两个地方做出了改变，一个是在embeddings中，另一个是在encoder中的self-attention
